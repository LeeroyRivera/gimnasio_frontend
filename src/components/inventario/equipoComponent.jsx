...
const Equipo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (equipoSeleccionado) {
        ...
        await api.put(
          `/api/inventario/equipo/editar?id=${equipoSeleccionado.id}`,
          formData
        );
        ...
        if (imagenFile) {
          ...
          await api.post(
            `/api/inventario/equipo/imagen?id=${equipoSeleccionado.id}`,
            formDataImagen,
            {
  ...
  const editarEquipo = (equipo) => {
    ...
    if (equipo.foto) {
      ...
      setImagenPreview(`${apiBase}/${equipo.foto}`);
    } else {
      setImagenPreview(null);
    }
    setImagenFile(null);
  ...
  const equiposFiltrados = equipos.filter((equipo) => {
    ...
    return (
      ...
      equipo.categoria_equipo?.nombre_categoria
        ?.toLowerCase()
