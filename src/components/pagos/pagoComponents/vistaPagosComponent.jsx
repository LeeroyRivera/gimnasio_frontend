    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle>
        ...
        >
          ...
          >
            {" "}
            <ReceiptIcon sx={{ mr: 2 }} color="primary" /> Detalles del Pago{" "}
          </Typography>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <Typography variant="body1" fontWeight="600">
                    {pagoDetalle.membresia?.cliente?.nombre}{" "}
                    {pagoDetalle.membresia?.cliente?.apellido}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  <Chip
                    ...
                    color={
                      pagoDetalle.membresia?.estado === "Activa"
                        ? "success"
                        : "default"
                    }
                    size="small"
            ...
            <Card variant="outlined" sx={{ p: 2, bgcolor: "success.50" }}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  >
                    L{" "}
                    {pagoDetalle.monto?.toLocaleString("es-HN", {
                ...
                {pagoDetalle.notas && (
                  <Grid item xs={12}>
                    ...
                    <Typography variant="body1">{pagoDetalle.notas}</Typography>
                  </Grid>
                )}
              </Grid>
            </Card>
          ...
          {pagoDetalle.comprobante && (
            <Grid item xs={12}>
              <Card variant="outlined" sx={{ p: 2 }}>
                ...
                >
                  <img
                    src={`${API_BASE}/${pagoDetalle.comprobante}`}
                    ...
                    onClick={() =>
                      window.open(
                        `${API_BASE}/${pagoDetalle.comprobante}`,
                        "_blank"
                      )
                    }
                  />
